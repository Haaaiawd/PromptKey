...
Write-Host "正在启动 PromptKey..." -ForegroundColor Green
...
Start-Process -NoNewWindow -FilePath "cargo" -ArgumentList "run", "--bin", "promptkey"

Write-Host "PromptKey 已启动！" -ForegroundColor Green
Write-Host ""
